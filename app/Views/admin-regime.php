          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                <span style="font-size:0.78rem;color:var(--text-secondary);">Poisson, Huile d'olive, Légumes,
                  Fruits</span>
              </td>
            ...
            <tr>
              <td>
                ...
                <span style="font-size:0.78rem;color:var(--text-secondary);">Viandes maigres, Œufs, Légumineuses,
                  Whey</span>
              </td>
            ...
            <tr>
              <td>
                ...
                <span style="font-size:0.78rem;color:var(--text-secondary);">Avocats, Noix, Fromages, Viandes
                  grasses</span>
              </td>
              <td><span class="badge badge--orange">📉 Perte de poids</span></td>
              <td>1 500 kcal</td>
